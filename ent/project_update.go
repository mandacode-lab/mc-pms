...
func (_u *ProjectUpdate) SetNamespaceID(id string) *ProjectUpdate {
	_u.mutation.SetNamespaceID(id)
	return _u
}

// SetNillableNamespaceID sets the "namespace" edge to the Namespace entity by ID if the given value is not nil.
func (_u *ProjectUpdate) SetNillableNamespaceID(id *string) *ProjectUpdate {
	if id != nil {
		_u = _u.SetNamespaceID(*id)
	}
	return _u
}
...
// SetNamespaceID sets the "namespace" edge to the Namespace entity by ID.
func (_u *ProjectUpdateOne) SetNamespaceID(id string) *ProjectUpdateOne {
	_u.mutation.SetNamespaceID(id)
	return _u
}

// SetNillableNamespaceID sets the "namespace" edge to the Namespace entity by ID if the given value is not nil.
func (_u *ProjectUpdateOne) SetNillableNamespaceID(id *string) *ProjectUpdateOne {
	if id != nil {
		_u = _u.SetNamespaceID(*id)
	}
	return _u
